...
Drop database if exists DBKinExY; 
Create database DBKinExY;
...
Create table Usuario(
 ...
 Delimiter  $$
    Create procedure sp_AgregarUsuario(in codigoUsuario int,in rol varchar(50),in nombreUsuario varchar (100) ,
    in usuarioLogin varchar(50), in contrasena varchar (50))
        Begin
        Insert into Usuario(codigoUsuario,rol,nombreUsuario,usuarioLogin,contrasena)
            values (codigoUsuario,rol,nombreUsuario,usuarioLogin,contrasena);
        End$$
Delimiter ;

 

call sp_AgregarUsuario(1111,'admin','Samuel rodriguez','Samuel','165');
call sp_AgregarUsuario(2222,'admin','Diego Suarez','suarez','56');
call sp_AgregarUsuario(3333,'root','Victor Alvarez','victor','924');
call sp_AgregarUsuario(4444,'root','Jose Texajum','jtejaxun','625');
